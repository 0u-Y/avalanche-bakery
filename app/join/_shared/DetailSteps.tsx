...
export function NicknameStep({ nickname, onNickname, onNext, onBack }: {
  ...
  return (
    <>
      <StepHeading eyebrow="STEP 03 · 이름" title="앞 화면에 뜰 이름을 정해요" copy="내 쿠키가 오븐과 진열장으로 갈 때 이 이름이 함께 보여요." />
...
export function SubmitStep({ nickname, preview, onSubmit, onBack }: {
  ...
  return (
    <>
      <StepHeading eyebrow="STEP 05 · 제출" title="이제 앞 화면으로 보내요" copy="보낸 뒤에는 쿠키가 작업대에서 오븐으로 이동해요." />
